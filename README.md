...
| `hydradb` | HydraDB push support (Bolt via the neo4j driver) | `uv tool install "graphifyy[hydradb]"` |
...
/graphify ./raw --hydradb-push bolt://localhost:7687   # HydraDB (auth token via HYDRADB_TOKEN)
